    ...
    <div name="contact" className="w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white">
        <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
            <div className="pb-8">
                ...
                <p className="py-6 ">Get in touch.. Send me an email</p>
            </div>
            <div className="flex justify-center items-center">
                <form
                 action=" https://getform.io/f/979e93e7-4e79-4af1-bcc8-d91c9c95c072"
                 method="POST"
                  ...
                  >
                    ...
                    name="message"
                     ...
                     <button 
                       ...
                       flex item-center rounded-md hover:scale-110 
                       duration-300">
                        Submit
                     </button>
                </form>
